...
if (isset($_POST["action"])) {
	if ($_POST["action"] == 'fetch') {
		...
		$main_query = "SELECT id as row_id, flow_rate, total_pos_flow, signal_strength, update_date FROM history $search_text ORDER BY update_date DESC, update_time DESC ";
