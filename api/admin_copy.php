    ...
    switch($redirect) {
        ...
        case "history_fetch":
            ...
            if ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                ...
                $results_arr["flow_rate"] = $row['flow_rate'];
                $results_arr["total_pos_flow"] = $row['total_pos_flow'];
                $results_arr["signal_strength"] = $row['signal_strength'];
                $results_arr["update_date"] = $row["update_date"];
